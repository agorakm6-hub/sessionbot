...
# Токен бота можно заменить или передать через переменную окружения BOT_TOKEN
TOKEN = os.getenv("BOT_TOKEN", "YOUR_BOT_TOKEN_HERE")
MODERATOR_CHAT_ID = -1001954345678  # ID чата модераторов (например, для https://t.me/gayclubl используйте числовой ID)
